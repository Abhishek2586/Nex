...
def main():
    ...
    training=sub.add_parser('train'); training.add_argument('kind',choices=['baseline','neural']); training.add_argument('--dataset',choices=['synthetic'],default='synthetic')
