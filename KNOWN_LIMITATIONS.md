...
- Browser flows were exercised in the actual app at desktop and 390×844 narrow widths with no horizontal overflow; keyboard focus, WebSocket updates, prompt feedback, explanations, federation jobs, restart persistence and evidence views were inspected. Automated cross-browser coverage and a recorded demo video are absent.
