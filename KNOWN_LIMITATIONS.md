...
- All executed model and federation results use seeded synthetic data as well as the successfully acquired, imported and evaluated WESAD research dataset.
...
- The WESAD offline evaluation produces research metrics only and must NOT be considered clinical validation or real-world stress-detection accuracy.
