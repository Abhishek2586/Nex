...
$backend = Start-Process -FilePath "$PSScriptRoot\.venv\Scripts\python.exe" -ArgumentList "-m","uvicorn","nexora.edge.app:app","--reload","--port","8000" -WorkingDirectory $PSScriptRoot -PassThru -WindowStyle Normal
